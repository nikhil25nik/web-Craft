...
const Generate = () => {
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-[#050505] via-[#0b0b0b] to-[#050505] text-white'>
         ...
         <div className="sticky top-0 z-50 backdrop-blur-xl bg-black/50 border-b border-white/25">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-lg font-semibold">WebCraft</h1>
          </div>
        </div>
      ...
      <div className='max-w-6xl mx-auto px-6 py-16'>
        ...
        >
          <h1 className='text-4xl md:text-5xl font-bold mb-5 leading-tight'>Build Websites 
            <span className='block bg-linear-to-r from-white to-zinc-400 bg-clip-text text-transparent'>With Real AI power</span></h1>
            <p className='text-zinc-400 mx-auto'>This process may take several minutes</p>
        </motion.div>
        <div className='mb-14'>
          <h1 className='text-xl font-semibold mb-2'>Describe your website</h1>
          <div className='relative'>
            <textarea onChange={(e)=>setPrompt(e.target.value)} value={prompt} placeholder='Describe your thoughts about your website....'
        ...
        {loading && (
          ...
          >
            ...
            <div className='text-center text-xs text-zinc-400 mt-4'>
              ...
              <span className='text-white font-medium'>~8-11 minutes</span>
